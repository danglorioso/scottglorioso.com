          ...
          <div>
            ...
            <ul className="space-y-4">
              {album.tracks.map((track, index) => (
                <li key={track.id}>
                  <Link href={`/songs/${track.id}`} className="block">
                    <div className="flex justify-between items-center bg-neutral-800 p-4 rounded-lg hover:bg-neutral-700 transition cursor-pointer">
