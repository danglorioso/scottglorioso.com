...
const StreamingLinks = () => {
  ...
  return (
    <section className="bg-neutral-900 text-white rounded-lg max-w-max mx-auto">
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-2 justify-items-stretch">
        {platforms.map((platform) => (
          <a
            ...
            className="flex flex-col items-center justify-center space-y-2 bg-neutral-800 hover:bg-neutral-700 transition-colors hover:scale-105 duration-300 p-3 rounded-lg w-40 shadow-lg"
          >
