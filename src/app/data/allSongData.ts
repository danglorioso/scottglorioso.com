...
But not for fools like you`,
  ...
  "music-in-me": {
    ...
    streamingLinks: [
      ...
      { name: "Spotify", url: "https://open.spotify.com/track/4qwjUjA5gVcoldBuY2qhEU?si=e62b74d1de5548b1", icon: FaSpotify },
...
I've still got the music in me`,
  ...
  "all-i-see": {
    ...
    streamingLinks: [
      ...
      { name: "Spotify", url: "https://open.spotify.com/track/2IRzAC4WXm3d56nEqc59Ox?si=c361ddd080284ad6", icon: FaSpotify },
...
You and me were made to be forever`,
  ...
  "my-kind-of-success": {
    ...
    streamingLinks: [
      ...
      { name: "Spotify", url: "https://open.spotify.com/track/0mULzQ4meYQ5c03IA4SiHD?si=7d96db040b1f484c", icon: FaSpotify },
...
It’s my kind of success`,
  ...
  "sunshine-rising": {
    ...
    streamingLinks: [
      ...
      { name: "Spotify", url: "https://open.spotify.com/track/16W6glZNBWW0fmk4L39BGG?si=f955fd0e1c084eeb", icon: FaSpotify },
...
I am not regretting today`,
  ...
  "it-takes-a-lot": {
    ...
    streamingLinks: [
      ...
      { name: "Spotify", url: "https://open.spotify.com/track/0r9fVOefBjnZodgxPkzcUi?si=919c71771d844c32", icon: FaSpotify },
...
"Forever stay the same"`,
  ...
  "out-on-the-mountain": {
    ...
    streamingLinks: [
      ...
      { name: "Spotify", url: "https://open.spotify.com/track/2XPGBkrbg5imRng4LC1g7E?si=308845ca8115490c", icon: FaSpotify },
...
Where it's just me I've got to please`,
  ...
  "once-in-a-lifetime": {
    ...
    streamingLinks: [
      ...
      { name: "Spotify", url: "https://open.spotify.com/track/4cxZqEc9rWM8B5ldMxfdSa?si=4ef000edfa9f457c", icon: FaSpotify },
...
You better go for it all`,
  ...
  "no-fun-without-you": {
    ...
    streamingLinks: [
      ...
      { name: "Spotify", url: "https://open.spotify.com/track/70QDG4SJrzVQ56ctxuaLKi?si=fa6811ce4009458a", icon: FaSpotify },
...
And it's no fun without you`,
  ...
  "anothers-way": {
    ...
    streamingLinks: [
      ...
      { name: "Spotify", url: "https://open.spotify.com/track/5FQhkCFjOwODxWsQaszhLK?si=1666aa446d294fc9", icon: FaSpotify },
...
Another's theory of life`,
  ...
  "queen-requiem": {
    ...
    streamingLinks: [
      ...
      { name: "Spotify", url: "https://open.spotify.com/track/5FAthQxLnewtIRzFqUQCuL?si=fc459e4d45464c5c", icon: FaSpotify },
